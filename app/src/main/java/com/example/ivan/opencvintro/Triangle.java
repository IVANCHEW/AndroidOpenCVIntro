...
public class Triangle {
    ...
    private static final String TAG = "Triangle Class";
    ...
    //Initialization of the Triangle class involves defining fixed vertices,
    //projection matrix, loading the shaders and initialising the handlers
    public Triangle(){
        ...
        Log.d(TAG,"Renderer, load shader program");
